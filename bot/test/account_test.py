...
def test_initializeCostBasis1():
    assert account.initializeCostBasis('./bot/mocks/trade_activity_mock1.csv') == 0
    
def test_initializeCostBasis2():
    assert account.initializeCostBasis('./bot/mocks/trade_activity_mock2.csv') == 57836.54409126203
...
def test_updateFeePercent1():
    assert account.updateFeePercent('./bot/mocks/trade_activity_mock1.csv') == 0.0018

def test_updateFeePercent2():
    assert account.updateFeePercent('./bot/mocks/trade_activity_mock2.csv') == 0.002